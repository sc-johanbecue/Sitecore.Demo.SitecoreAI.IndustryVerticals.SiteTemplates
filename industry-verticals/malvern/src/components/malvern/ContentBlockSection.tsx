    ...
    >
      <div className="mx-auto max-w-7xl px-4">
        ...
        >
          ...
          {/* Text Content */}
          <div className="w-full flex-1">
            <h2 className="text-malvern-teal-dark mb-4 text-2xl leading-snug font-bold lg:text-3xl">
            ...
            {fields.BulletPoints?.value && (
              <div className="content-block-bullets [&_li]:before:bg-malvern-teal mb-6 text-sm leading-relaxed text-[#555] lg:text-base [&_li]:relative [&_li]:mb-2 [&_li]:pl-5 [&_li]:before:absolute [&_li]:before:top-2 [&_li]:before:left-0 [&_li]:before:h-1.5 [&_li]:before:w-1.5 [&_li]:before:rounded-full [&_li]:before:content-[''] [&_ul]:list-none [&_ul]:pl-0">
