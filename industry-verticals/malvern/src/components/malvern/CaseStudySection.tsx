...
export const Default = (props: CaseStudySectionProps): JSX.Element => {
  ...
  return (
    <section
      className={`component case-study-section bg-background-muted py-12 lg:py-16 ${styles || ''}`}
      id={id}
    >
      <div className="mx-auto max-w-7xl px-4">
        {/* Title + Subtitle */}
        <div className="mb-12 text-center">
          <h2 className="text-malvern-teal-dark mb-4 text-3xl font-bold lg:text-4xl">
        ...
        <div className="grid gap-8 lg:grid-cols-2 lg:gap-12">
          ...
          <div className="flex flex-col justify-center rounded-lg bg-white p-6 shadow-sm lg:order-1 lg:p-8">
            {/* Client Logo */}
            <div className="mb-8">
              <SitecoreImage
            ...
            {/* Quote */}
            <div className="text-foreground mb-6 text-lg leading-relaxed lg:text-xl">
              <RichText field={fields.Quote} />
            </div>

            {/* Quote Author */}
            <p className="text-malvern-teal-dark mb-8 text-sm font-semibold">
