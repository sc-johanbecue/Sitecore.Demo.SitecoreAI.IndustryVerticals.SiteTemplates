  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
        ...
        {/* ===== DESKTOP: Text tabs with blue underline (Malvern) ===== */}
        <div className="intro-tabs-desktop-bar hidden justify-center md:flex">
          <nav
            className="relative z-10 -mb-px flex flex-wrap items-end justify-center gap-1 border-b border-gray-200 px-1"
            role="tablist"
            aria-label="Tabs"
          >
