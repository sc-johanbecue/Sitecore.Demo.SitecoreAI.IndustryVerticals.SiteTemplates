  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-4">
        <h2 className="text-malvern-teal-dark mb-8 text-center text-lg font-bold lg:text-xl">
        ...
        <div className="relative">
          ...
          {showArrows && (
            <button
              type="button"
              onClick={goPrev}
              className="bg-malvern-teal-dark hover:bg-malvern-teal absolute top-1/2 -left-2 z-10 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-full text-white shadow-md transition-colors"
          ...
          {showArrows && (
            <button
              type="button"
              onClick={goNext}
              className="bg-malvern-teal-dark hover:bg-malvern-teal absolute top-1/2 -right-2 z-10 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-full text-white shadow-md transition-colors"
            ...
            {Array.from({ length: realCount }).map((_, i) => (
              <button
                ...
                className={`h-2 w-2 rounded-full transition-all ${
                  activeIndex % realCount === i ? 'bg-malvern-green scale-125' : 'bg-gray-300'
                }`}
