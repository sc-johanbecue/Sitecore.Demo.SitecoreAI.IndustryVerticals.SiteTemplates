...
export const Default = (props: ArticlesCarouselSectionProps): JSX.Element => {
  ...
  return (
    <section
      className={`component articles-carousel-section bg-white py-12 lg:py-20 ${styles || ''}`}
      id={id}
    >
      <div className="mx-auto max-w-7xl px-4">
        <h2 className="text-malvern-teal-dark mb-10 text-center text-2xl font-bold lg:mb-12 lg:text-3xl">
        ...
        <div className="relative">
          ...
          {totalSlides > 1 && (
            <button
              onClick={handlePrev}
              className="bg-malvern-teal-dark hover:bg-malvern-teal absolute top-1/2 left-0 z-10 flex h-12 w-12 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full text-white shadow-md transition-colors lg:h-14 lg:w-14"
          ...
          {totalSlides > 1 && (
            <button
              onClick={handleNext}
              className="bg-malvern-teal-dark hover:bg-malvern-teal absolute top-1/2 right-0 z-10 flex h-12 w-12 translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full text-white shadow-md transition-colors lg:h-14 lg:w-14"
