  ...
  return (
    ...
    >
      <div className="mx-auto max-w-2xl px-4">
        {/* Title */}
        <h2 className="text-malvern-teal-dark mb-4 text-center text-2xl font-bold lg:text-3xl">
        ...
        <form className="flex flex-col gap-5" onSubmit={(e) => e.preventDefault()}>
          ...
          <div>
            ...
            <input
              type="text"
              className="focus:border-malvern-teal focus:ring-malvern-teal/30 w-full rounded border border-gray-300 px-4 py-2.5 text-sm text-[#333] outline-none focus:ring-1"
            />
          </div>
          ...
          <div>
            ...
            <select className="focus:border-malvern-teal focus:ring-malvern-teal/30 w-full rounded border border-gray-300 bg-white px-4 py-2.5 text-sm text-[#333] outline-none focus:ring-1">
