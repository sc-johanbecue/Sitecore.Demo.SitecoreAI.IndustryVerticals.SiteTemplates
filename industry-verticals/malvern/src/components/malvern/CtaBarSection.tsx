      ...
      <div className="flex items-center justify-between px-3 py-2">
        ...
        <div className="flex items-center gap-3">
          {fields.Logo?.value?.src ? (
            ...
            <span className="text-malvern-teal text-lg font-bold">M</span>
          )}
        ...
        {fields.FreeQuoteLink?.value?.href && (
          <SitecoreLink
            ...
            className="border-malvern-teal text-malvern-teal hover:bg-malvern-teal inline-flex items-center rounded border-2 px-3 py-1 text-xs font-semibold transition-colors hover:text-white"
          >
