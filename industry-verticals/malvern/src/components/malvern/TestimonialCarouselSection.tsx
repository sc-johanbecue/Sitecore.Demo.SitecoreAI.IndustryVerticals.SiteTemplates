 ...
 *
 * Layout:
 * - Light gray page band with white testimonial cards
...
export const Default = (props: TestimonialCarouselSectionProps): JSX.Element => {
  ...
  return (
    <section
      className={`component testimonial-carousel-section bg-background-muted py-12 lg:py-16 ${styles || ''}`}
      id={id}
    >
      <div className="mx-auto max-w-5xl px-4">
        {/* Label */}
        <p className="text-malvern-teal-dark mb-8 text-center text-xs font-bold tracking-widest uppercase">
        ...
        <div className="relative">
          ...
          {totalSlides >= 2 && (
            <button
              onClick={handlePrev}
              className="bg-malvern-teal-dark hover:bg-malvern-teal absolute top-1/2 left-0 z-10 flex h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full text-white shadow-md transition-colors lg:-left-16"
          ...
          {totalSlides >= 2 && (
            <button
              onClick={handleNext}
              className="bg-malvern-teal-dark hover:bg-malvern-teal absolute top-1/2 right-0 z-10 flex h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full text-white shadow-md transition-colors lg:-right-16"
