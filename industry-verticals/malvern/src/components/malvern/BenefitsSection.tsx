...
export const Default = (props: benefitsSectionProps): JSX.Element => {
  ...
  return (
    <section
      className={`component benefits-section bg-background-muted py-12 lg:py-16 ${styles || ''}`}
      id={id}
    >
      <div className="mx-auto max-w-7xl px-4">
        <h2 className="text-malvern-teal-dark mb-10 text-center text-2xl font-bold lg:mb-14 lg:text-3xl">
          <Text field={fields.Title} />
        </h2>

        <div className="benefits-description text-foreground-light mb-10 text-center text-base lg:text-lg">
