...
const LinkListItem = ({
  ...
  return (
    <li className={classNames}>
      <ContentSdkLink
        field={field}
        className="hover:text-malvern-teal flex items-center justify-between border-b border-gray-100 py-3 text-sm text-[#333] transition-colors"
      >
    ...
    return (
      <div className="flex h-full flex-col rounded-lg border border-gray-200/80 bg-white shadow-md">
        ...
        <div className="flex grow flex-col p-6">
          ...
          {/* Title */}
          <h3 className="text-malvern-teal-dark mb-3 text-center text-xl font-bold">
